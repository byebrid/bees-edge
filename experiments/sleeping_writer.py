"""
This is for testing whether sleeping the *writer* actually improves performance or 
not. 
"""
...
if __name__ == "__main__":
    ...
    for i in range(NUM_TRIALS):
        ...
        config.sleeping_writer = not config.sleeping_writer